...
|-------------|------------|----------|------|------|
| 4 - 4 - 4 | 15,000 | 90,000 | 적체 | Sink 병목 확인 |
| 4 - 4 - 4 | 25,000 | 75,000 | 적체 감소 | Sink 성능 개선, 처리량 부족 |
| 8 - 8 - 8 | 25,000 | 18,000 | 적체 대폭 감소 | 개선 여지 있음 |
| 16 - 16 - 16 | 25,000 | 40,000 | 적체 오히려 증가 | 성능 이슈로 자원 배분이 원활하지 않은 것으로 보임 |
| 12 - 12 - 12 | 25,000 (인터벌 1초) | 5,500 | 최적화 | Sweet Spot |
| 12 - 12 - 12 | 50,000 (인터벌 2.5초) | 6,700 | 적체 소폭 증대 | 인터벌 증가로 인한 차이(성능-비용 트레이드 오프) |

- 트러블 슈팅
  : 하단의 노션 링크 접속 후 목차 4-F(성능테스트 및 시각화)에서 확인
